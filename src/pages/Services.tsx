        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
              End-to-end AI automation solutions designed to simplify your most complex challenges.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 space-y-8 max-w-4xl">
          {services.map((service, i) => (
            <motion.div
              ...
              className="rounded-xl border border-border bg-card p-8 border-l-4 border-l-primary card-hover"
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div>
                  <h4 className="text-sm font-heading font-semibold text-muted-foreground uppercase tracking-wider mb-3">The Problem</h4>
                ...
                <div>
                  <h4 className="text-sm font-heading font-semibold text-primary uppercase tracking-wider mb-3">The Outcome</h4>
                  <ul className="space-y-2">
      ...
      <section className="py-24 cta-gradient">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
            Ready to Discover Your <span className="text-primary">Flow</span>?
          </h2>
          <p className="text-muted-foreground max-w-lg mx-auto mb-8">
            Book a free consultation and let us show you what's possible.
          </p>
